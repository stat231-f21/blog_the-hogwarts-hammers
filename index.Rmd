...
To compare male and female suicide rates, we calculated the ratio of male suicide rate to female suicide rate. We combined these data sets together to look for meaningful correlations. The world bank publishes extensive data on historical and projected climate data. We downloaded an excel file with their historical temperature and precipitation data and extracted this to CSV files to explore the impact of temperature on suicide rates.

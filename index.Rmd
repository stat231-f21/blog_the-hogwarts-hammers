...
ggplot(suicideData2016, aes(x = SuicideDeathRate, y = TOTAL_BEDS)) +
  xlim(0, 30) +
  labs(title = "How number of mental health beds relates to suicide rate", y = "Total number of mental health beds per 100,000 people", x = "Suicide rate per 100,000") +
  geom_point() +
  geom_smooth(method = lm)
```

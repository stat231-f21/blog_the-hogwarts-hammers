...
MHHospitals <- read_csv("data/MentalHealthHospitalsByCountry.csv")
suicideRate <- read_csv("data/SuicideRatesByCountry.csv")
sexualViolence <- read_csv("data/NonPartnerSexualViolenceByCountry.csv")
```

...
leaflet(leafletSuicideData2016) %>%
  ...
  addCircles(lat = leafletSuicideData2016@data$LAT, lng = leafletSuicideData2016@data$LON, weight = 1, opacity = 1, fillOpacity = .5, radius = sqrt(leafletSuicideData2016@data$TOTAL_BEDS) * 20000, color = "#ff77ff") %>%
